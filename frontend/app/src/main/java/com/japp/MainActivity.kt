...
fun JappApp() {
    ...
    // Determine if current screen is full screen
    val isFullScreenDestination = currentRoute in listOf(
        AppDestinations.EDITPROFILE.route
    ) || currentRoute?.startsWith("group/") == true && currentRoute.endsWith("/options")
...
enum class AppDestinations(
    ...
    EDITPROFILE("Edit Profile", Icons.Default.ManageAccounts, { navController -> EditProfileScreen(navController) });
